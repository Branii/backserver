...
<span id="deactivate-game-text" class="hidden" style="display: none;"><?= $translator['game_name'] ?? 'Game Name' ?></span>
<span id="deactivate-game-type" class="hidden" style="display: none;"><?= $translator['game_type'] ?? 'Game Type' ?></span>
<span id="deactivate-game-group" class="hidden" style="display: none;"><?= $translator['game_group'] ?? 'Game Group' ?></span>
