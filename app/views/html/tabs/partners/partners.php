...
<div class="card w-100 position-relative overflow-hidden">
    ...
    <form action="" class="betform">
            <span class="top-left-btn">
                <div class="btn-group mb-2" role="group" aria-label="Basic example" style="padding: 5px;width: 125%;">
                <div style="width: 23%;">
          
                    <input name="resultsList" class="queryholderlist form-control bring-forward" id="ptn-search-partners-names" data-user-id="" placeholder="Platform Names" autocomplete="off" style="width: 98%;"> <div class="ptn-names-wrapper ngp-usr-res-wrapper" style="width: 22.3%; z-index: 1000;"> <ul style="max-height: 403px;margin: 0px; overflow-y:auto;" id="ptn-names-list-wrapper"></ul> </div>
                    <input name="usernames" type="hidden" id="ptn-selectedID" value="">
                    </div>

                    <select name="state" id="ptn-filter-state" class="form-control form-select queryholderuserlistz states" data-bs-placeholder="Select Type">
                        <option value="">--State--</option>
                        <option value="1">Active</option>
                        <option value="2">Blocked</option>
                    </select>

                    <input name="startdate" id="ptn-start-date" type="date" class="form-control queryholderuserlistz startdateuser" aria-describedby="name" placeholder="Name">

                    <input name="enddate" id="ptn-end-date" type="date" class="form-control queryholderuserlistz enddateuser" aria-describedby="name" placeholder="Name">
                </div>
            </span>
        ...
        <div class="table-responsive mb-4 border rounded-1 table-wrapperuserlist" id="maskuserlist"
            ...
            <thead class="text-dark fs-4 tbl-headeruserlist">
                    <tr class="headrowuserlist">
                        ...
                        <th>
                            <h6 class="fs-4 fw-semibold mb-0">Creation Date</h6>
                        </th>
                        <th>
                            <h6 class="fs-4 fw-semibold mb-0">Last Update</h6>
                        </th>
                        <th>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="agentform">
                    ...
                    <!-- Email Field -->
                    <!-- <div class="form-floating mb-3">
                        <input name="agentemail" type="email" class="form-control border border-infos"
                            placeholder="Email" />
                        <label>
                    ...
                    <!-- <div class="form-floating mb-3">
                        <input name="agentpassword1" type="password" class="form-control border border-infos"
...
<div id="ptn-manage-user" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ptn-contact" placeholder="Contact"
                                            disabled />
                                    </div>
                                    <div class="mb-3">
                                        <label for="userEmail" class="form-label"><?= $translator['Whatsapp']; ?></label>
                                        <input type="email" class="form-control" id="ptn-whatsapp"
                                            placeholder="whatsapp" disabled />
                                    </div>
                                    <div class="mb-3">
                                        <label for="userEmail" class="form-label"><?= $translator['Username']; ?></label>
                                        <input type="email" class="form-control" id="ptn-username"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ptn-account-type"
                                            placeholder="Account Type" disabled />
                                    </div>
                                    <div class="mb-3">
                                        <label for="ptn-state" class="form-label"><?= $translator['State']; ?></label>
                                        <select id="ptn-state" class="form-select">
                                    ...
                                    <div class="mb-3">
                                        <label for="ptn-rebate" class="form-label"><?= $translator['Rebate (%)']; ?></label>
                                        <input type="text" class="form-control" id="ptn-rebate"
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ptn-remarks" placeholder="<?= $translator['Remarks']; ?>"
                                            disabled />
                                    </div>
                                    <div class="mb-3">
                                        <label for="ptn-deposit-limit" class="form-label"><?= $translator['Deposit Limit']; ?></label>
                                        <input type="text" class="form-control" id="ptn-deposit-limit"
                                            placeholder="<?= $translator['Deposit Limit']; ?>" />
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="ptn-withdrawal-limit" class="form-label"><?= $translator['Withdrawal Limit']; ?></label>
                                        <input type="text" class="form-control" id="ptn-withdrawal-limit"
                                            placeholder="<?= $translator['Withdrawal Limit']; ?>" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="ptn-daily-betting-total-limit" class="form-label"><?= $translator['Daily Betting']; ?>
                                        <?= $translator['Total Limit']; ?></label>
                                        <input type="text" class="form-control" id="ptn-daily-betting-total-limit"
                    ...
                    <div class="card-body">
                        ...
                        <form id="accountDetailsForm">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="ptn-login-password" class="form-label"><?= $translator['Login Password']; ?></label>
                                        <input type="password" class="form-control" id="ptn-login-password"
                                            placeholder="Login Password<?= $translator['Login Password']; ?>" disabled />
                                    </div>

                                    <div class="mb-3">
                                        <label for="ptn-withdrawal-password" class="form-label"><?= $translator['Withdrawal Password']; ?></label>
                                        <input type="password" class="form-control" id="ptn-withdrawal-password"
                                            placeholder="Withdrawal Password<?= $translator['Withdrawal Password']; ?>" disabled />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="ptn-accounting-binding" class="form-label"><?= $translator['Account Binding']; ?></label>
                                        <input type="password" class="form-control" id="ptn-accounting-binding"
                                            placeholder="<?= $translator['Account Binding']; ?>" disabled />
                                    </div>
                                    <div class="mb-3">
                                        <label for="ptn-security" class="form-label"><?= $translator['Security']; ?></label>
                                        <input type="password" class="form-control" id="ptn-security"
            ...
            <div class="modal-body">
                ...
                <div class="text-center mt-2 mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <i class="bx bx-message-square-x ptn-listclose"
                            style="color: #868c87; font-size: 25px; cursor: pointer;" data-bs-dismiss="modal"
                            aria-label="Close"></i>
                    </div>
                </div>
                    ...
                    <div class="modal-body scrollable-container">
                        <div style="overflow: hidden;">
                            <table class="table table-hover table-bordered text-nowrap mb-0" id="quotatable">
                                ...
                                <tbody id="ptn-lot-dtholder"></tbody>
                            </table>
                        </div>
                    </div>
                    <div class="d-md-flex align-items-center">
                        ...
                        <div class="mt-3 mt-md-0 ms-auto">
                            <button type="button" class="btn hstack gap-6 ptn-listclose"
                                style="border: solid 1px #ccc;">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="d-md-flex align-items-center">
                        ...
                        <div class="mt-3 mt-md-0 ms-auto">
                            <button type="button" class="btn hstack gap-6 ptn-delete-userbtn"
                                style="border: solid 1px #ccc;color: #e60e38!important;">
...
<div id="ptn-relationship-dialog" class="modal fade" tabindex="-1" aria-modal="true" role="dialog"
    style="display: none; top: 363px; left: 191px;">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content" style="width: 75%;">
            <div class="modal-body">
