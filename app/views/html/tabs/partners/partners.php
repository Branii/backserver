<style>
    ...
    .table-wrapperpartner::-webkit-scrollbar {
        width: 5px;
    ...
    .table-wrapperpartner::-webkit-scrollbar-track {
        background: #f1f1f1;
        /* Lighter background for track */
        border-radius: 5px;
    }

    .table-wrapperpartner::-webkit-scrollbar-thumb {
    ...
    .table-wrapperpartner::-webkit-scrollbar-thumb:hover {
...
<span id="lang-main-info" style="display: none;"><?= $translator['main_info']; ?></span>
<span id="lang-payment-settings" style="display: none;"><?= $translator['payment_settings']; ?></span>
<span id="lang-product-settings" style="display: none;"><?= $translator['product_settings']; ?></span>
<span id="lang-currency-settings" style="display: none;"><?= $translator['currency_settings']; ?></span>
<span id="lang-language-settings" style="display: none;"><?= $translator['language_settings']; ?></span>
<span id="lang-partners-label" style="display: none;"><?= $translator['partners_label']; ?></span>
...
<div class="card w-100 position-relative overflow-hidden">
    ...
    <div class="card-body p-4">
        <div class="table-responsive mb-4 border rounded-1 table-wrapperpartner" id="ptns-maskfinances" style="height: 37rem; overflow-y: scroll;">
            <table class="table text-nowrap mb-0 align-middle table-bordered">
                <thead class="text-dark fs-4 tbl-financeheads">
                    <tr class="partheadrows">
                        <th>
    ...
    <div class="px-4 py-3 border-top pagerlist">
        <span class="toplist-left-btn">
            <div class="btn-group mb-2" role="group" aria-label="Basic example" style="border: solid 1px #eee; color: #bbb; background-color: #fff;">
                ...
                <button type="button" class="btn bg-white-subtle playerpartner" value="leftpart">
                    <i class="bx bx-chevron-left" style="font-size: 20px;"></i>
                </button>
                <button type="button" class="btn bg-white-subtle playerpartner" value="rightpart">
            ...
            <div class="scrollable-container">
                <div class="card border mb-4">
                    <div class="card-body">
                        ...
                        <form id="ptns-pp-personalDeailsFormg">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="pp-currency-edit-partner" class="form-label">Currency (<span style="color: #a01616;">*</span>)</label>
                                        <select id="ptns-pp-currency-edit-partner" class="form-select currency-list"></select>
                                    </div>

                                    <div class="mb-3">
                                        <label for="pp-status-edit-partner" class="form-label">Status (<span style="color: #a01616;">*</span>)</label>
                                        <select id="ptns-pp-status-edit-partner" class="form-select">
...
<div class="card w-100 position-relative overflow-hidden" style="display: none;">
    ...
    <div class="card-body p-4">
        <div class="table-responsive mb-4 border rounded-1 table-wrapperfinances" id="maskfinances" style="height: 530px; overflow-y: scroll;">
            <table class="table text-nowrap mb-0 align-middle table-bordered">
                <thead class="text-dark fs-4 tbl-partnerheads">
            ...
            <div class="scrollable-container">
                <div class="card border mb-4">
                    <div class="card-body">
                        ...
                        <form id="pp-personaetailsForm">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="userName" class="form-label">Partner (<span style="color: #a01616;">*</span>)</label>
                                        <input type="text" class="form-control" id="pp-contac" placeholder="Enzerhub" disabled="" />
                                    </div>
                                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="scrollable-container">
                <div class="card border mb-4">
                    <div class="card-body">
                        <h4 class="card-title">Enzerhub Payment Platforms</h4>
                        <form id="pp-pesonaletailsForm">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="userName" class="form-label">Partner (<span style="color: #a01616;">*</span>)</label>
                                        <input type="text" class="form-control" id="pp-contct" placeholder="Enzerhub" disabled="" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="pp-status-edit-payment" class="form-label">Status (<span style="color: #a01616;">*</span>)</label>
                                        <select id="pp-status-edit-payment" class="form-select">
                                            <option value="active">Active</option>
                                            <option value="hidden">Hidden</option>
                                            <option value="inactive">Inactive</option>
                                        </select>
                ...
                <div class="card w-100 position-relative overflow-hidden" style="/* display:none; */">
                    ...
                    <div class="px-4 py-3 border-bottom pagerlist">
                        <span class="top-left-btn" style="width: 70%;">
                            <div class="btn-group mb-2" role="group" aria-label="Basic example" style="padding: 5px; width: 100%;">
                                <div style="width: 35%;">
                                    <input name="resultsList" class="queryholderlist form-control bring-forward" id="platformNamess" data-user-id="" placeholder="Platform Names" autocomplete="off" style="width: 98%;" />
                                    <div class="pp-names-wrapper ngp-usr-res-wrapper" style="width: 20.5%;"><ul style="max-height: 403px; margin: 0px; overflow-y: auto;" id="pp-names-list-wrapper"></ul></div>
                                    <input name="usernames" type="hidden" id="selectedID" value="" />
                                </div>
            ...
            <div class="scrollable-container">
                <div class="card border mb-4">
                    <div class="card-body">
                        ...
                        <form id="pp-personlDetailsForm">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="userName" class="form-label">ID</label>
                                        <input type="text" class="form-control" id="ppcontactt" placeholder="Enzerhub" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="ppcurrency-edit" class="form-label">Bank Name</label>

                                        <input type="text" class="form-control" id="pp-ee-edit" placeholder="Bank Name" />
                                    </div>

                                    <div class="mb-3">
                                        <label for="pp-site-url-edi" class="form-label">Bank Code</label>
                                        <input type="text" class="form-control" id="pp-site-url-edix" placeholder="e.g 123445" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="pp-admin-site-urledit" class="form-label">Bank Account Number</label>
                                        <input type="text" class="form-control" id="pp-admin-site-urledit" placeholder="e.g 02343454654657565" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="pp-site-url-ed" class="form-label">Bank Account Branch</label>
                                        <input type="text" value="Achimota" class="form-control" id="pp-site-url-ediv" placeholder="Bank Account Branch" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="pp-admin-sit-url-edit-y" class="form-label">IBAN</label>
                                        <input type="text" value="20" class="form-control" id="pp-admin-sit-url-edit-y" placeholder="IBAN" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="pp-feeditt" class="form-label">Account Owner Name</label>
                                        <input type="text" value="1000" class="form-control" id="pp-feeditt" placeholder="Account Owner Name" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="pp-currency-main-info" class="form-label">Currency</label>
                                        <select id="pp-currency-main-info" class="form-select currency-list">
                                            <option value="">--Currency--</option>
                                    ...
                                    <div class="mb-3">
                                        <label for="pp-priority-main-info-edit" class="form-label">Payment Systems Integration</label>
                                        <select id="pp-status-edit-main-info" class="form-select">
                                            <option value="active">Active</option>
                                            <option value="hidden">Hidden</option>
                                            <option value="inactive">Inactive</option>
                                        </select>
