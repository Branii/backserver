...
return [
    ...
    'Personalise your dashboard' => 'Personalise your dashboard',
    'Manage dashboard' => 'Manage dashboard',
    'Personalise' => 'Personalise',
    'Todo list 1' => 'Todo list 1',
    'Todo list 2' => 'Todo list 2',
    'Todo list 3' => 'Todo list 3',
    'Todo list 4' => 'Todo list 4',
    'Todo list 5' => 'Todo list 5',
    //payment platform
    ...
    "Togo" => "Togo",
    "Tonga" => "Tonga",
    "Trinidad and Tobago" => "Trinidad and Tobago", // corrected to full name below
    "Tunisia" => "Tunisia",
    "Turkey" => "Turkey",
    ...
    'Add an extra layer of security to your account by enabling two-factor authentication (2FA).' => 'Add an extra layer of security to your account by enabling two-factor authentication (2FA).',
    'Authentication App' => 'Authentication App',
    'Use an app like Google Authenticator or Authy to generate secure codes.' => 'Use an app like Google Authenticator or Authy to generate secure codes',
    'Set up' => 'Set up',
    'Change Password' => 'Change Password',
    'You can reset your default password' => 'You can reset your default password',
    'Change' => 'Change',
    'Enable' => 'Enable',
    ...
    'FailedToSetInactive' => 'FailedToSetInactive',
    'SetInactiveSuccess' => 'SetInactiveSuccess',
    'SelectFilterFields' => 'SelectFilterFields',
    'Select One Or More Fields' => 'Select One Or More Fields',
    ...
    'AlreadyBlocked' => 'This user has already been blocked.',
    ...
    'UsernamePattern' => 'Username must contain only letters, numbers, and underscores and start with a letter',
    'InvalidEmail' => 'Email address is invalid',
    'PasswordNumber' => 'Password must contain at least one number',
    'PasswordCase' => 'Password must contain at least one uppercase and lowercase letter',
    ...
    'No permissions selected. Update not sent.' => 'No permissions selected. Update not sent.',
    'Information' => 'Information',
    'Select date(s) to filter' => 'Select date(s) to filter',
    'Heads up!' => 'Heads up!',
    'Please select or type an admin to search' => 'Please select or type an admin to search',
    'active' => 'active',
    'suspended' => 'suspended',
    ...
    'Too many users available' => 'Too many users available',
    'Please select a single user' => 'Please select a single user',
    ...
    'BACKUP_STATUS_INACTIVE' => 'Inactive',
    'BACKUP_STATUS_SUSPENDED' => 'Suspended',
    'Save menu' => 'Save menu',
    'READ' => 'Read',
    'UNREAD' => 'Unread',
    'ALL_FIELDS_REQUIRED' => 'All Fields Required',
    'CANNOT_UPDATE_IF_EMPTY' => 'Cannot update if fields are empty',
    'HEADS_UP' => 'Heads up!!',
    ...
    'LOTTERY_STATUS_UPDATED' => 'Lottery',
    'LOTTERY_UPDATED' => 'Lottery Data Successfully Updated.',
    ...
    'bank_state_in_force' => 'In Force',
    'bank_state_not_active' => 'Not Active',
    'bank_state_terminated' => 'Terminated',
    'bank_state_deleted' => 'Deleted',
    'status_active' => 'Active',
    ...
    "of" => "of",
    "pages" => "pages",
    "No Rule" => "No Rule", // English default
    "Stop If Not Win" => "Stop If Not Win",
    "Stop If Win" => "Stop If Win",
    "Timezone/hrs" => "Timezone/hrs",
    "Turned On" => "Turned On",
    ...
    'Confirm' => 'Confirm',
    'Submit Lottery' => 'Submit Lottery',
    'Add New Lottery' => 'Add New Lottery',
    'Lottery name' => 'Lottery name',
    'Alias' => 'Alias',
    'Lottery Type' => 'Lottery Type',
    'Select Game Group' => 'Select Game Group',
    'Number of Balls' => 'Number of Balls',
    'Seconds Issue' => 'Seconds Issue',
    'Min Ball' => 'Min Ball',
    'Max Ball' => 'Max Ball',
    'Start time' => 'Start time',
    'Stop time' => 'Stop time',
    'Lottery model' => 'Lottery model',
    ...
    'Failed to approve withdrawal' => 'Failed to approve withdrawal',
