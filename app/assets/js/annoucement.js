$(function () {
  ...
  $(document).on("click", ".sendmessagebtn", function () {
      ...
      $.post(`../admin/annoucement/${messagetype}/${messagetitle}/${usernames}/${description}/${sendby}`, function (response) {
  ...
  $(document).on("click", ".editmsg", function () {
      ...
      $.post(`../admin/editannoucement/${msgid}`, function (response) {
          ...
          $("#note-has-titles").val(data.title);
          $("#descriptions").val(data.content);
