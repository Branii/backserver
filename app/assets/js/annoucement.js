$(function () {
  ...
  function renderfinacePaginations(
    totalPages,
    currentPage,
    pageLimit,
    callback
    ...
    document
      .querySelectorAll("#paginationmessage .page-link")
      .forEach((link) => {
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", function (e) {
      ...
      if (
        !$(e.target).closest(
          "#financeDropdownnotify, #userfinaceDropdownnotify"
        ).length
      ) {
        $dropdownbet.hide();
      }
  ...
  function tableScrollFinancess() {
    const tableContainerFinances = document.querySelector(
      ".table-wrapperfinances"
    );
