$(function () {
  ...
  function renderPaginationusernoti(
    totalPages,
    currentPage,
    pageLimit,
    callback
  ...
  async function filterUserNotifys(
    username,
    messagestype,
    startnotfys,
    endnotfys,
  ...
  function tableScrollUsernoti() {
    const tableContainerusernoti = document.querySelector(
      ".table-wrapperusernoti"
    );
