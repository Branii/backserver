$(function () {
    ...
    async function fetchuserpayment(page, pageLimit) {
        try {
            const response = await fetch(`../userbank/fetchuserpaymentmethod/${page}/${pageLimit}`);
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", function (e) {
            ...
            if (!$(e.target).closest("#transuserpayment, #userpaymentAccountDropdown").length) {
                $dropdown.hide();
            }
        });
    ...
    function fetchbetUser(query) {
        ...
        $.post(`../admin/Searchusernames/${encodeURIComponent(query)}`, function (response) {
            try {
                ...
                response.forEach((user) => {
                    ...
                    let regusername = "";
                    if (regtype === "email" && query.toLowerCase() === email.toLowerCase()) {
                        displayusername = email;
                        regusername = email;
                    } else if (regtype === "username" && query.toLowerCase() === username.toLowerCase()) {
                        displayusername = username;
                        regusername = username;
                    } else if (regtype === "contact" && query.toLowerCase() === contact.toLowerCase()) {
