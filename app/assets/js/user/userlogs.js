$(function() {
  ...
  const translations = {
    ...
    noChanges: document.getElementById("trans-no-changes-made").dataset
      .translation,
    alertTitle: document.getElementById("trans-alert").dataset.translation,
    userDoesNotExist: document.getElementById("trans-user-does-not-exist")
      .dataset.translation,
    errorTitle: document.getElementById("trans-error").dataset.translation,
    errorMessage: document.getElementById("trans-generic-error").dataset
      .translation,
    noPages: document.getElementById("trans-no-pages").dataset.translation,
    mainPageNotice: document.getElementById("trans-main-page-notice").dataset
      .translation,
    success: document.getElementById("trans-success").dataset.translation,
    agentAdded: document.getElementById("trans-agent-added").dataset
      .translation,
    quotaUpdated: document.getElementById("trans-quota-updated").dataset
      .translation,
    blocked: document.getElementById("trans-blocked").dataset.translation,
    alreadyBlocked: document.getElementById("trans-already-blocked").dataset
      .translation,
    delete: document.getElementById("trans-delete").dataset.translation,
    invalidOperation: document.getElementById("trans-invalid-operation").dataset
      .translation,
    error: document.getElementById("trans-error").dataset.translation,
    genericError: document.getElementById("trans-generic-error").dataset
      .translation,
    requestError: document.getElementById("trans-request-error").dataset
      .translation,
    enabled: document.getElementById("trans-enabled").dataset.translation,
    lotteryEnabled: document.getElementById("trans-lottery-enabled").dataset
      .translation,
    disabled: document.getElementById("trans-disabled").dataset.translation,
    lotteryDisabled: document.getElementById("trans-lottery-disabled").dataset
      .translation,
    errorProcessing: document.getElementById("trans-error-processing").dataset
      .translation,
    successful: document.getElementById("trans-successful").dataset.translation,
    recordsUpdated: document.getElementById("trans-records-updated").dataset
      .translation,
    ...
    noAgentMessage: document.getElementById("trans-no-agent-message").dataset
      .translation,
    emailExists: document.getElementById("trans-email-exists").dataset
      .translation,
    usernamePattern: document.getElementById("trans-username-pattern").dataset
      .translation,
    invalidEmail: document.getElementById("trans-invalid-email").dataset
      .translation,
    passwordNumber: document.getElementById("trans-password-number").dataset
      .translation,
    passwordCase: document.getElementById("trans-password-case").dataset
      .translation,
    passwordSpecial: document.getElementById("trans-password-special").dataset
      .translation,
    confirmPassword: document.getElementById("trans-confirm-password").dataset
      .translation,
    passwordLength: document.getElementById("trans-password-length").dataset
      .translation,
    passwordRequired: document.getElementById("trans-password-required").dataset
      .translation
  };
  ...
  const UserlogsData = data => {
    ...
    data.forEach(item => {
      ...
      timezone =
        timezone[0] +
        `<span style="margin-left: 1rem;">GMT${timezone[1]}</span>`;
      html += `
                  <tr>
                      <td>${username}</td>
  ...
  async function fetchUserlogs(page, pageLimit) {
    try {
      ...
      renderuserlogPagination(
        data.totalPages,
        page,
        pageLimit,
        (newPage, pageLimit) => fetchUserlogs(newPage, pageLimit)
      );
  ...
  async function filterUserlogs(
    ...
    try {
      const response = await fetch(
        `../user/filterUserlogs/${usernamelog}/${startdatelog}/${enddatelog}/${currentPage}/${pageLimit}`
      );
      const data = await response.json();
      console.log(response);
      //  return
      ...
      document.getElementById("paging_infologs").innerHTML =
  ...
  function renderuserlogPagination(
    totalPages,
    currentPage,
    pageLimit,
    callback
  ...
  function tableScrollUserLogs() {
    const tableContainerUserLogs = document.querySelector(
      ".table-wrapperuserlogs"
    );
