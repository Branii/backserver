$(function () {
 ...
 tableScrollpayment();
    ...
    // let isPasting = false; 
    // $(document).ready(function () {
    //     // Event listener for keyup on #paymentinput
    //     $(document).on('keyup', '#paymentinput', function (event) {
    ...
    //         } else {
    //             $('.paymentDropdown').hide(); // Hide dropdown if input is less than 2 characters or from pasting
    //         }
    //     });
    ...
    //         if (selectedUserId) {
    //             $('#paymentinput').val(selectedUsername);
    //             $('.userIdpaye').val(selectedUserId);
    ...
    //         if (!$(e.target).closest("#paymentinput, #userfinaceDepo").length) {
    //             $dropdownbet.hide();
    //         }
    //     });
    ...
    //    $(document).on('paste', '#paymentinput', function () {
    ...
    //     $(document).on('input', '#paymentinput', function () {
    //         if (!$(this).val()) {
    //             $('.userIdpaye').val(''); // Reset user ID if input is cleared
    //             // $('.paymentDropdown').hide();
    //         }
    //     });
    // });
    ...
    //             $('.paymentDropdown').html(optionsHtml).show();
    //         } catch (error) {
...
//     $(".numrowspayment").change(function () {
//         $("#maskpayment").LoadingOverlay("show", {
//             background: "rgb(90,106,133,0.1)",
//             size: 3,
//           });
//         const paymentrows = $(this).val();
//         fetchpayment(currentPage,paymentrows)
//       });
...
//       $(".userpayment").on("input paste", function () {
//         const self = this;
//         setTimeout(() => {
//           // Trim leading spaces
